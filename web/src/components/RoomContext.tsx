...
export function RoomContext({ room, participants = [], connected = false, tab, open, drawer, panelRef, onTab, onClose, onCreateInvite = unavailable, onRevokeInvite = unavailable, onRecoverInvites = unavailable }: {
